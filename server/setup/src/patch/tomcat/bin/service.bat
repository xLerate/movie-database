...
REM sascha.ehrkamp@aperto.de 20160429
REM added ";-XX:MaxPermSize=256M;-Duser.timezone=Europe/Berlin;-Dfile.encoding=UTF8" to JvmOptions
REM changed memory options: --JvmMs 256 / -JvmMx 4096 / --JvmSs 512
"%EXECUTABLE%" //IS//%SERVICE_NAME% ^
    --Description "Apache Tomcat 7.0.62 Server - http://tomcat.apache.org/" ^
